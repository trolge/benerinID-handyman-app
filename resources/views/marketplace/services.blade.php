    ...
    <style>
        ...
        * {
        ...
        .filter-select {
            ...
            appearance: none;
            background: white url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" stroke="%236b7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>') no-repeat right 0.75rem center;
        ...
        .direct-browse-banner h2 {
            font-size: 2rem;
            font-weight: 800;
            margin-bottom: 1rem;
        }

        .direct-browse-banner p {
            font-size: 1.1rem;
            opacity: 0.9;
            margin-bottom: 2rem;
            max-width: 600px;
    ...
    <div class="container">
        ...
        <div class="services-grid" id="servicesGrid">
            @foreach($categories as $cat)
                <div class="service-card" data-title="{{ strtolower($cat['name']) }}"
                    data-desc="{{ strtolower($cat['desc']) }}">
                    <div class="card-img-wrap">
                        <img src="{{ $cat['image'] }}" alt="{{ $cat['name'] }}">
                        <div class="btn-heart">
                            <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="#9ca3af" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path
        ...
        <div class="direct-browse-banner">
            ...
            <p>Skip the categories and browse our entire verified directory of expert craftsmen, handymen, and
                specialists.</p>
