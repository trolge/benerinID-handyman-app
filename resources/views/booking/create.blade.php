...
<head>
    ...
    <style>
        ...
        * {
        ...
        .date-cell:hover:not(.empty):not(.disabled) {
            background: var(--input-bg);
        }
            ...
            <div class="booking-grid">
                ...
                <div class="form-card">
                    <div class="form-group">
                        ...
                        <input type="text" name="JobName" class="text-input" placeholder="e.g., Leaking Sink in Kitchen"
                            value="{{ old('JobName') }}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" style="margin-bottom:0;">
                        ...
                        <input type="file" id="hiddenFileInput" name="JobImages[]" style="display:none;"
                ...
                <div class="sidebar">
                    ...
                    <div class="handyman-card">
                        ...
                        <div class="hm-hours">
                            ...
                            Working Hours:
                            {{ \Carbon\Carbon::parse($handyman->WorkingHoursStart ?? '09:00')->format('g:i A') }} –
                            {{ \Carbon\Carbon::parse($handyman->WorkingHoursEnd ?? '17:00')->format('g:i A') }}
                        </div>
                    </div>
                    ...
                    <div class="cal-card">
                        ...
                        <div class="cal-header">
                            <div class="cal-nav" id="calPrev"><svg viewBox="0 0 24 24" width="18" height="18"
                                    fill="none" stroke="currentColor" stroke-width="2.5">
                                    <polyline points="15 18 9 12 15 6"></polyline>
                                </svg></div>
                            <div class="cal-title" id="calTitle">MAY 2026</div>
                            <div class="cal-nav" id="calNext"><svg viewBox="0 0 24 24" width="18" height="18"
                                    fill="none" stroke="currentColor" stroke-width="2.5">
